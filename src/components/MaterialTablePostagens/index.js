...
import DialogPost from '../DialogPost/index';
...
export default function MaterialTablePostagens(props) {
  ...
  async function handleEdit(id) {
    swal({
      title: "Deseja editar a postagem?",
      icon: "warning", 
      buttons: {
        confirm: "Sim",
        cancel: "Não"
